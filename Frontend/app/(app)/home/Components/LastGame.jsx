...
function State({ title, state1, state2 }) {
	return (
		<div className="w-[250px] flex justify-between">
			<h1 className="font-Chakra font-semibold text-[15px] text-white">
				{state1}
			</h1>
			<h1 className="font-Chakra font-bold text-[15px] text-white">
				{title}
			</h1>
			<h1 className="font-Chakra font-semibold text-[15px] text-white">
				{state2}
...
function LastGame() {
	...
	return (
		<div className=" w-[50%] max-[1990px]:w-[40%] h-[424px] rounded-[15px] flex flex-col items-center justify-center gap-[20px] max-[710px]:w-[90%]">
			<h2 className="font-Chakra font-bold text-[20px] text-white">
				Last Game
			</h2>
			<div>
				<GameState user1={user} user2={user2} />
				<img className="w-[254px] h-[66px]" src={gameTable} alt="" />
			</div>
