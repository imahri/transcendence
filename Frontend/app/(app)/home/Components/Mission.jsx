...
export function Mission({ mission }) {
	...
	return (
		...
		>
			...
			<h3 className="font-Chakra font-bold text-[15px] text-white">
				{title}
			</h3>
			<h1 className="font-Chakra font-bold text-[30px] text-white">
				{exp}{" "}
				<span className="font-Chakra font-bold text-[14px] text-white">
					Exp
				</span>
			</h1>
			<div>
				<h3 className="font-Chakra font-bold text-[8px] text-[#E6E6E6]">
					Prize
				</h3>
				<div className="w-[85px] bg-[#D9D9D9] bg-opacity-[19%] rounded-[2px] flex  items-center justify-center gap-[10px] ml-[10px]">
					<h3 className="font-Chakra font-bold text-[14px] text-white flex justify-center items-center gap-[5px]">
			...
			<div className="w-[95%] h-[30px] flex items-center justify-between">
				<div>
					<h1 className="font-Chakra font-bold text-[11px] text-white">
						{owner.userName}
					</h1>
					<h2 className="font-Chakra font-bold text-[9px] text-[#C8C8C8]">
						{owner.fullName}
					</h2>
				</div>
				{MoreSvg}
	...
	return (
		...
		>
			...
			<div className="pl-[20px]">
				...
				<h1 className="font-Chakra font-bold text-[48px] max-[1706px]:text-[30px] text-white">
					{exp}{" "}
					<span className="font-Chakra font-bold text-[14px] text-white">
						Exp
					</span>
