...
const LGame = () => {
	...
	useEffect(() => {
		const userScore_ = localStorage.getItem("userScore");
		const comScore_ = localStorage.getItem("userScore");
		// if (userScore_)
		setUserScore(userScore_);
		setComScore(localStorage.getItem("comScore"));
		// if (comScore_)
		// 	setUserScore(comScore_)
	});
