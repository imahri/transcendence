...
let c_com = "black";
let gaa = false;
export const Youchen = ({ userScore, comScore }) => {
	...
	useEffect(() => {
		...
		function update() {
			...
			// com.y += (ball.y - (com.y + com.height/2)) - 100;
			...
			if (ball.x - ball.radius < 0) {
				localStorage.setItem("comScore", com.score);
				com.score++;
				console.log(" com.score ", com.score);
				resetBall();
			} else if (ball.x + ball.radius > canvas.width) {
				localStorage.setItem("userScore", com.score);
				user.score++;
