...
export function PopupSetup2Fa(props) {
	...
	return (
		<div className="w-[620px] max-[650px]:w-[90%] flex flex-col items-center gap-[20px] bg-[#343434] rounded-[25px] shadow-[0_4px_40px_5px_rgba(0,0,0,0.7)] relative">
			...
			<h2 className=" font-semibold text-[20px] text-gray-300 text-opacity-60 max-[560px]:text-[15px] max-[560px]:font-medium max-[460px]:text-[12px]">
			...
			{!QrImage && (
				<div className="animate-shake bg-red-600 w-[60%] h-[40px] rounded-[5px] flex justify-center items-center max-[560px]:w-[80%]">
					{errorSvg}
					<span className=" p-[5px] text-white max-[460px]:text-[14px] max-[360px]:text-[10px]">
				...
				<div className="w-[90%] flex flex-col items-center gap-[20px] bg-[#343434] rounded-[25px] shadow-[0_4px_40px_5px_rgba(0,0,0,0.7)] relative">
					...
					<div className="w-full m-[30px] flex justify-center items-center">
						<input
							...
							className={`rounded-[10px] w-[40%] h-[50px] outline-none  font-bold text-[30px] text-black text-center max-[560px]:w-[80%] ${error ? "animate-shake border-[1px]  border-red-600" : ""}`}
							type="text"
							maxLength="6"
							autoFocus={true}
						/>
