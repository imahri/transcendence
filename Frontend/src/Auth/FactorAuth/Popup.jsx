...
export function PopupEnternumber(props) {
  ...
  function getnumber(e, index) {
    ...
    if (isNaN(number)){
      ...
      setTimeout(() => {
        document.getElementById(index.toString()).classList.remove('error-input');
      } , 1000);
      return;
    }
        ...
        <div className="popUp">
          ...
          <div className="allNumber">
            <div className="threeNumber">
              <input onChange={(e) => getnumber(e, 1)} type="text" maxLength="1" id="1" disabled={inputIndex != 1} autoFocus={inputIndex === 1}/>
              <input onChange={(e) => getnumber(e, 2)} type="text" maxLength="1" id="2" disabled={inputIndex != 2} autoFocus={inputIndex === 2}/>
              <input onChange={(e) => getnumber(e, 3)} type="text" maxLength="1" id="3" disabled={inputIndex != 3} autoFocus={inputIndex === 3}/>
            </div>
            <div className="threeNumber">
              <input onChange={(e) => getnumber(e, 4)} type="text" maxLength="1" id="4" disabled={inputIndex != 4} autoFocus={inputIndex === 4}/>
              <input onChange={(e) => getnumber(e, 5)} type="text" maxLength="1" id="5" disabled={inputIndex != 5} autoFocus={inputIndex === 5}/>
              <input onChange={(e) => getnumber(e, 6)} type="text" maxLength="1" id="6" disabled={inputIndex != 6} autoFocus={inputIndex === 6}/>
            </div>
          </div>
